...
const theme: Theme = {
  ...
  select: {
    ...
    '--focus-outline-color': 'var(--color-coat-of-arms)',
    '--assistive-color': 'var(--color-black-60)',
    '--menu-divider-color': 'var(--color-black-20)',
    '--menu-item-background-color-default': 'var(--color-white)',
    '--menu-item-background-color-hover': 'var(--color-black-10)',
    '--menu-item-background-color-selected': 'var(--color-white)',
    '--menu-item-background-color-selected-hover': 'var(--color-black-10)',
    '--menu-item-background-color-disabled': 'var(--color-white)',
    ...
    '--menu-item-icon-color-selected': 'var(--color-black-90)',
