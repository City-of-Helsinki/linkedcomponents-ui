...
const theme: Theme = {
  ...
  eventNavigation: {
    ...
    '--circle-background-color-disabled': 'var(--color-bus-medium-light)',
    '--circle-border-color-disabled': 'var(--color-bus-medium-light)',
    '--circle-color-disabled': 'var(--color-white)',
    '--connection-line-color': 'var(--color-bus-medium-light)',
    '--label-color': 'var(--color-black-90)',
  },
