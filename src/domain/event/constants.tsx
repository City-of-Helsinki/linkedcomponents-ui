...
export const EVENT_ACTION_ICONS = {
  [EVENT_ACTIONS.CANCEL]: <IconCalendarCross />,
  [EVENT_ACTIONS.COPY]: <IconCalendarPlus />,
  [EVENT_ACTIONS.DELETE]: <IconCross />,
  [EVENT_ACTIONS.EDIT]: <IconCogwheel />,
  [EVENT_ACTIONS.POSTPONE]: <IconCalendarClock />,
  [EVENT_ACTIONS.PUBLISH]: <IconCheck />,
  [EVENT_ACTIONS.UPDATE_DRAFT]: <IconPen />,
  [EVENT_ACTIONS.UPDATE_PUBLIC]: <IconPen />,
};
...
export const EVENT_ACTION_LABEL_KEYS = {
  ...
  [EVENT_ACTIONS.PUBLISH]: 'event.form.buttonAcceptAndPublish',
