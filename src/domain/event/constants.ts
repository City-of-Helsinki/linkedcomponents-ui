...
export enum EXTENSION_COURSE_FIELDS {
  ...
  ENROLMENT_START_DATE = 'enrolmentStartDate',
...
export const EVENT_INITIAL_VALUES: EventFields = {
  ...
  [EVENT_FIELDS.AUDIENCE_MAX_AGE]: null,
  [EVENT_FIELDS.AUDIENCE_MIN_AGE]: null,
  ...
  [EVENT_FIELDS.EXTENSION_COURSE]: {
    [EXTENSION_COURSE_FIELDS.ENROLMENT_END_DATE]: null,
    [EXTENSION_COURSE_FIELDS.ENROLMENT_END_TIME]: '',
    [EXTENSION_COURSE_FIELDS.ENROLMENT_START_DATE]: null,
    [EXTENSION_COURSE_FIELDS.ENROLMENT_START_TIME]: '',
    [EXTENSION_COURSE_FIELDS.MAXIMUM_ATTENDEE_CAPACITY]: null,
    [EXTENSION_COURSE_FIELDS.MINIMUM_ATTENDEE_CAPACITY]: null,
  },
