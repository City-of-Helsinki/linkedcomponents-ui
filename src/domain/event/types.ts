...
export type EventFields = {
  ...
  [EVENT_FIELDS.AUDIENCE_MAX_AGE]: number | null;
  [EVENT_FIELDS.AUDIENCE_MIN_AGE]: number | null;
...
export type ExtensionCourse = {
  [EXTENSION_COURSE_FIELDS.ENROLMENT_END_DATE]: Date | null;
  [EXTENSION_COURSE_FIELDS.ENROLMENT_END_TIME]: string;
  [EXTENSION_COURSE_FIELDS.ENROLMENT_START_DATE]: Date | null;
  [EXTENSION_COURSE_FIELDS.ENROLMENT_START_TIME]: string;
  [EXTENSION_COURSE_FIELDS.MAXIMUM_ATTENDEE_CAPACITY]: number | null;
  [EXTENSION_COURSE_FIELDS.MINIMUM_ATTENDEE_CAPACITY]: number | null;
};
