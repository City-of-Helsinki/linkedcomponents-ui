...
test('should search events with correct search params', async () => {
  ...
  await shouldFilterEventsOrRegistrations({
    ...
    expectedSearch:
      '?eventStatus=EventCancelled&place=place%3A1&publisher=organization%3A1&type=general&full_text=search&end=2021-03-12&start=2021-03-05',
    history,
...
test('should initialize search panel inputs', async () => {
  ...
  renderComponent(`${ROUTES.SEARCH}?full_text=${searchValue}`);
