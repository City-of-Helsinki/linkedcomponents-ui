...
export const KEYWORD_FORM_COMBOBOX_FIELDS = [KEYWORD_FIELDS.PUBLISHER];

export const KEYWORD_FORM_SELECT_FIELDS = [KEYWORD_FIELDS.REPLACED_BY];

export const KEYWORD_TEXT_FIELD_MAX_LENGTH = {
  [KEYWORD_FIELDS.ORIGIN_ID]: 100,
  [KEYWORD_FIELDS.NAME]: 255,
};
