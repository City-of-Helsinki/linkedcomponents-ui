...
export const PLACE_FORM_COMBOBOX_FIELDS = [PLACE_FIELDS.PUBLISHER];

export const PLACE_TEXT_FIELD_MAX_LENGTH = {
  [PLACE_FIELDS.ADDRESS_REGION]: 255,
  [PLACE_FIELDS.ADDRESS_LOCALITY]: 255,
  [PLACE_FIELDS.CONTACT_TYPE]: 255,
  [PLACE_FIELDS.EMAIL]: 254,
  [PLACE_FIELDS.NAME]: 255,
  [PLACE_FIELDS.ORIGIN_ID]: 100,
  [PLACE_FIELDS.INFO_URL]: 1000,
  [PLACE_FIELDS.POST_OFFICE_BOX_NUM]: 255,
  [PLACE_FIELDS.POSTAL_CODE]: 128,
  [PLACE_FIELDS.STREET_ADDRESS]: 255,
  [PLACE_FIELDS.TELEPHONE]: 128,
};
