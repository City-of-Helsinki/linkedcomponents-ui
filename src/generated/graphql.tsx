...
export type CreateRegistrationMutationInput = {
  ...
  minimumAttendeeCapacity?: InputMaybe<Scalars['Int']>;
  registrationUsers?: InputMaybe<Array<InputMaybe<RegistrationUserInput>>>;
...
export type Mutation = {
  ...
  sendRegistrationUserInvitation?: Maybe<NoContent>;
...
export type MutationSendRegistrationUserInvitationArgs = {
...
export type Registration = {
  ...
  minimumAttendeeCapacity?: Maybe<Scalars['Int']>;
  publisher?: Maybe<Scalars['String']>;
  registrationUsers?: Maybe<Array<Maybe<RegistrationUser>>>;
  remainingAttendeeCapacity?: Maybe<Scalars['Int']>;
...
export type RegistrationUserFieldsFragment = { __typename?: 'RegistrationUser', email?: string | null, id?: number | null };
...
export type SendRegistrationUserInvitationMutationVariables = Exact<{
  id: Scalars['Int'];
}>;


export type SendRegistrationUserInvitationMutation = { __typename?: 'Mutation', sendRegistrationUserInvitation?: { __typename?: 'NoContent', noContent?: boolean | null } | null };
...
export const RegistrationUserFieldsFragmentDoc = gql`
    fragment registrationUserFields on RegistrationUser {
  email
  id
}
    `;
...
${RegistrationUserFieldsFragmentDoc}
${EnrolmentFieldsFragmentDoc}`;
...
export const SendRegistrationUserInvitationDocument = gql`
    mutation SendRegistrationUserInvitation($id: Int!) {
  sendRegistrationUserInvitation(id: $id) @rest(type: "NoContent", path: "/registration_user/{args.id}/send_invitation/", method: "POST", bodyKey: "id") {
    noContent
  }
}
    `;
export type SendRegistrationUserInvitationMutationFn = Apollo.MutationFunction<SendRegistrationUserInvitationMutation, SendRegistrationUserInvitationMutationVariables>;

/**
 * __useSendRegistrationUserInvitationMutation__
 *
 * To run a mutation, you first call `useSendRegistrationUserInvitationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSendRegistrationUserInvitationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [sendRegistrationUserInvitationMutation, { data, loading, error }] = useSendRegistrationUserInvitationMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useSendRegistrationUserInvitationMutation(baseOptions?: Apollo.MutationHookOptions<SendRegistrationUserInvitationMutation, SendRegistrationUserInvitationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SendRegistrationUserInvitationMutation, SendRegistrationUserInvitationMutationVariables>(SendRegistrationUserInvitationDocument, options);
      }
export type SendRegistrationUserInvitationMutationHookResult = ReturnType<typeof useSendRegistrationUserInvitationMutation>;
export type SendRegistrationUserInvitationMutationResult = Apollo.MutationResult<SendRegistrationUserInvitationMutation>;
export type SendRegistrationUserInvitationMutationOptions = Apollo.BaseMutationOptions<SendRegistrationUserInvitationMutation, SendRegistrationUserInvitationMutationVariables>;
