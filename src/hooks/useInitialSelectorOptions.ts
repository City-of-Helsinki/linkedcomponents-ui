 ...
 * Updates options when data changes or when any tracked dependencies change.
 * NOTE: This is needed when HDS Select options is updated via onSearch and
 * this will only set the initial options.
 *
